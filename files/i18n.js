...
(function(){
  ...
  var btn=document.createElement('button');btn.className='bc-btn';btn.type='button';btn.setAttribute('aria-label','Abrir soporte BRAVA');btn.textContent='✦';
